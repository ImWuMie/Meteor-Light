...
public class Mesh {
    ...
    public long getIndicesPointer() {return indicesPointer;}

    public int getIndicesCount() {return indicesCount;}

    public void setIndicesCount(int count) {this.indicesCount = count;}
    ...
    public void quad(int i1, int i2, int i3, int i4,Color color) {
        color(color);
