...
import meteordevelopment.meteorclient.gui.screens.MainScreen;
...
public class Blur extends Module {
    ...
    public final Setting<Boolean> meteor = sgScreens.add(new BoolSetting.Builder()
        .name("meteor")
    ...
    public final Setting<Boolean> inventories = sgScreens.add(new BoolSetting.Builder()
        .name("inventories")
    ...
    public final Setting<Boolean> mainmenu = sgScreens.add(new BoolSetting.Builder()
        .name("main-menu")
        .description("Applies blur to main-menu screens.")
        .defaultValue(true)
        .build()
    );

    public final Setting<Boolean> chat = sgScreens.add(new BoolSetting.Builder()
        .name("chat")
    ...
    public final Setting<Boolean> other = sgScreens.add(new BoolSetting.Builder()
        .name("other")
    ...
    public Blur() {
        ...
        MeteorClient.EVENT_BUS.subscribe(new ConsumerListener<>(WindowResizedEvent.class, event -> {
            if (fbo1 != null) {
                fbo1.resize(mc.getWindow().getFramebufferWidth(),mc.getWindow().getFramebufferHeight());
                fbo2.resize(mc.getWindow().getFramebufferWidth(),mc.getWindow().getFramebufferHeight());
            }
        }));
    ...
    private boolean shouldRender() {
        ...
        if (screen instanceof MainScreen) return mainmenu.get();
