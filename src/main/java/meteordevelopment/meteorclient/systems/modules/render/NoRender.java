...
public class NoRender extends Module {
    ...
    private final Setting<Boolean> noSignTextColor = sgWorld.add(new BoolSetting.Builder()
        .name("sign-text-color")
        .description("Disables rendering of text color on signs.")
        .defaultValue(false)
        .build()
    );
    ...
    public boolean noSignTextColor() {
        return isActive() && noSignTextColor.get();
    }
