...
public class Notifier extends Module {
    ...
    private final Setting<Boolean> sendChat = sgTotemPops.add(new BoolSetting.Builder()
        .name("SendChatMessage")
        .description("send info to chat")
        .defaultValue(false)
        .build()
    );
    ...
    private void onReceivePacket(PacketEvent.Receive event) {
        ...
        synchronized (totemPopMap) {
            ...
            if (sendChat.get()) {
                ...
                mc.player.sendChatMessage("[Notifier] " + entity.getEntityName()+ " popped " + +pops +popbzd + ".",null);
            }
        }
    }
