...
import meteordevelopment.meteorclient.utils.world.Ore;
import meteordevelopment.meteorclient.utils.world.seeds.Seed;
...
public class OreSim extends Module {
    ...
    public boolean isBlocked(Block block, BlockPos blockPos) {
        boolean i = false;
        for (BlockPos b : xrayidk) {
            i = mc.world.getBlockState(b).getBlock().equals(block);
        }

        return !((i) && (blockPos == null || BlockUtils.isExposed(blockPos)));
    }
}
