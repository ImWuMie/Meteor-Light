...
import meteordevelopment.meteorclient.systems.viaversion.commands.NMSCommandSender;
import meteordevelopment.meteorclient.systems.viaversion.commands.UserCommandSender;
import meteordevelopment.meteorclient.systems.viaversion.provider.AbstractFabricPlatform;
import meteordevelopment.meteorclient.systems.viaversion.util.FutureTaskId;
...
public class FabricPlatform extends AbstractFabricPlatform {
    ...
    private boolean kickServer(UUID uuid, String s) {
        ...
        if (server.isOnThread()) {
            ...
            MeteorClient.JLOGGER.log(Level.WARNING, "Weird!? Player kicking was called off-thread", new Throwable());
    ...
    protected ExecutorService asyncService() {
        return MeteorClient.ASYNC_EXECUTOR;
    }

    @Override
    protected EventLoop eventLoop() {
        return MeteorClient.EVENT_LOOP;
    }
}
