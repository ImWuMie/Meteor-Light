package meteordevelopment.meteorclient.systems.viaversion.service;
...
import meteordevelopment.meteorclient.systems.viaversion.AddressParser;
...
public class ProtocolAutoDetector {
                                ...
                                clientConnection.setPacketListener(new ClientQueryPacketListener() {
                                    ...
                                    public void onResponse(QueryResponseS2CPacket packet) {
                                        ...
                                        if (meta == null || (version = meta.getVersion()) == null) {
                                            ...
                                            future.complete(ver);
                                            MeteorClient.JLOGGER.info("Auto-detected " + ver + " for " + address);
                                        }
    ...
    public static CompletableFuture<ProtocolVersion> detectVersion(InetSocketAddress address) {
        try {
            ...
            MeteorClient.JLOGGER.log(Level.WARNING, "Protocol auto detector error: ", e);
