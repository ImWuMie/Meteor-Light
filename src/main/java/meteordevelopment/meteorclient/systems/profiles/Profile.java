...
import meteordevelopment.meteorclient.systems.hud.elements.ProfileHud;
...
public class Profile implements ISerializable<Profile> {
    ...
    public void load() {
        ...
        Profile thisObject = this;
        ProfileHud.lastLoadedProfile = String.valueOf(thisObject.name);
    }
