...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> toggleSound = sgMisc.add(new BoolSetting.Builder()
        .name("toggle-sound")
    ...
    public final Setting<Boolean> disableGLDEBUG = sgMisc.add(new BoolSetting.Builder()
