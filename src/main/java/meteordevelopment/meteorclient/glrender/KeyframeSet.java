...
import meteordevelopment.meteorclient.glrender.Keyframe.FloatKeyframe;
import meteordevelopment.meteorclient.glrender.Keyframe.IntKeyframe;
import meteordevelopment.meteorclient.glrender.Keyframe.ObjectKeyframe;
...
public class KeyframeSet implements Keyframes {
    ...
    public static FloatKeyframeSet ofFloat(@Nonnull float... values) {
        ...
        if (badValue) {
            MeteorGL.LOGGER.warn(Animator.MARKER, "Bad value (NaN) in float animator");
        }
