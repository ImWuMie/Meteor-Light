...
public final class MessageQueue {
        ...
        for (; ; ) {
            ...
            synchronized (this) {
                ...
                if (msg != null) {
                    if (now < msg.when) {
                        ...
                        msg.next = null;
                        if (DEBUG) LOGGER.info(MARKER, "Returning message: " + msg);
                        msg.markInUse();
                        return msg;
                    }
                } else {
            ...
            for (int i = 0; i < pendingIdleHandlerCount; i++) {
                ...
                try {
                    ...
                    LOGGER.fatal(MARKER, "IdleHandler threw exception", t);
                }
    ...
    void quit(boolean safe) {
        if (mWindow != null && window == null) {
            throw new IllegalStateException("Main thread not allowed to quit.");
        }

        if (window != null && mWindow == null) throw new IllegalStateException("Main thread not allowed to quit.");
    ...
    public void removeSyncBarrier(int token) {
        ...
        synchronized (this) {
            ...
            if (needWake && !mQuitting) {
                ...
                } else if (mWindow == null && window != null){
                    GLFW.glfwPostEmptyEvent();
                } else {
