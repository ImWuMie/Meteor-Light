...
import meteordevelopment.meteorclient.glrender.font.LineBreaker;
import meteordevelopment.meteorclient.glrender.util.GrowingArrayUtils;
...
public class StaticLayout extends Layout {
    ...
    private void calculateEllipsis(int lineStart, int lineEnd,
        ...
        if (where == TextUtils.TruncateAt.START) {
            if (mMaximumVisibleLineCount == 1) {
                ...
                MeteorGL.LOGGER.warn(MARKER, "Start Ellipsis only supported with one line");
            }
            ...
            if (mMaximumVisibleLineCount == 1) {
                ...
                MeteorGL.LOGGER.warn(MARKER, "Middle Ellipsis only supported with one line");
            }
        }
        mEllipsized = true;
    ...
    public int getHeight(boolean cap) {
        if (cap && mLineCount > mMaximumVisibleLineCount && mMaxLineHeight == -1) {
            MeteorGL.LOGGER.warn(MARKER, "maxLineHeight should not be -1. "
