...
import meteordevelopment.meteorclient.glrender.text.CharSequenceIterator;
...
public class WordIterator {
     ...
     */
    public WordIterator() {
        this(MeteorGL.getSelectedLocale());
    }
    ...
    public void setCharSequence(@Nonnull CharSequence charSequence, int start, int end) {
        if (0 <= start && end <= charSequence.length()) {
            ...
            mIterator.setText(new CharSequenceIterator(charSequence, mStart, mEnd).toString());
        } else {
