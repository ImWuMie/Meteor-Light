...
package meteordevelopment.meteorclient.glrender.test;
...
import meteordevelopment.meteorclient.glrender.font.FontPaint;
import meteordevelopment.meteorclient.glrender.material.MaterialCheckBox;
import meteordevelopment.meteorclient.glrender.material.MaterialRadioButton;
import meteordevelopment.meteorclient.glrender.opengl.GLTexture;
import meteordevelopment.meteorclient.glrender.opengl.TextureManager;
import meteordevelopment.meteorclient.glrender.text.Spannable;
import meteordevelopment.meteorclient.glrender.text.Spanned;
import meteordevelopment.meteorclient.glrender.text.TextPaint;
import meteordevelopment.meteorclient.glrender.text.style.*;
import meteordevelopment.meteorclient.glrender.util.FloatProperty;
import meteordevelopment.meteorclient.glrender.view.*;
import meteordevelopment.meteorclient.glrender.widget.*;
    ...
    public TestLinearLayout() {
        ...
        for (int i = 0; i < 11; i++) {
            ...
            if (i == 4) {
                ...
                v = textField;
                p = new LinearLayout.LayoutParams(MATCH_PARENT,
                        WRAP_CONTENT);
                ...
                p = new LinearLayout.LayoutParams(WRAP_CONTENT,
                        WRAP_CONTENT);
            } else if (i == 6) {
