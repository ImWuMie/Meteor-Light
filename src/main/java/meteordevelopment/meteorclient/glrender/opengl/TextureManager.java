...
import meteordevelopment.meteorclient.glrender.NativeImage;
...
public class TextureManager {
    ...
    public GLTexture getOrCreate(@Nonnull String namespace, @Nonnull String path, int flags) {
        ...
        try (InputStream stream = MinecraftClient.getInstance().getResourceManager().getResource(new Identifier(namespace, path)).get().getInputStream()) {
