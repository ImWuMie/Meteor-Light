...
import meteordevelopment.meteorclient.glrender.view.ViewRoot;
...
public final class MainWindow extends Window {
    ...
    MainWindow(long handle,int mScreenWidth,int mScreenHeight,int mWidth,int mHeight,int mScreenX,int mScreenY) {
        super(handle);
