...
import meteordevelopment.meteorclient.glrender.transition.Fade;
import meteordevelopment.meteorclient.glrender.transition.Transition;
import meteordevelopment.meteorclient.glrender.util.*;
import meteordevelopment.meteorclient.glrender.view.menu.MenuBuilder;
 ...
 * {@link meteordevelopment.meteorclient.glrender.widget.TextView}. The available properties and the methods
...
public class View implements Drawable.Callback {
    ...
    public boolean resolveLayoutDirection() {
        ...
        if (MeteorGL.getInstance().hasRtlSupport()) {
            ...
            switch (getRawLayoutDirection()) {
                ...
                case LAYOUT_DIRECTION_LOCALE:
                    if (TextUtils.getLayoutDirectionFromLocale(MeteorGL.getSelectedLocale()) ==
                            LAYOUT_DIRECTION_RTL) {
                        mPrivateFlags2 |= PFLAG2_LAYOUT_DIRECTION_RESOLVED_RTL;
                    }
                    break;
