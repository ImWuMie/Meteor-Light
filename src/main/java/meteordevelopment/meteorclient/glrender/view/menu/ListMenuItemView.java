...
import meteordevelopment.meteorclient.glrender.util.ColorStateList;
import meteordevelopment.meteorclient.glrender.util.StateSet;
    ...
    public ListMenuItemView() {
...

        {
...

            {
                ...
                mSubMenuArrowView.setScaleType(ImageView.ScaleType.CENTER);
