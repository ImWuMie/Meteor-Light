...
public interface ViewParent {
     ...
     */
    boolean onStartNestedScroll(@Nonnull View child, @Nonnull View target, @View.ScrollAxis int axes,
                                @View.NestedScrollType int type);
     ...
     */
    void onNestedScrollAccepted(@Nonnull View child, @Nonnull View target, @View.ScrollAxis int axes,
                                @View.NestedScrollType int type);
     ...
     * @param type   the type of input which cause this scroll event
     */
    void onStopNestedScroll(@Nonnull View target, @View.NestedScrollType int type);
    ...
    void onNestedScroll(@Nonnull View target, int dxConsumed, int dyConsumed, int dxUnconsumed,
                        int dyUnconsumed, @View.NestedScrollType int type, @Nonnull int[] consumed);
