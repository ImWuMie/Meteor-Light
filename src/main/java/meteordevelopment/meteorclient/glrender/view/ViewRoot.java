...
package meteordevelopment.meteorclient.glrender.view;

import meteordevelopment.meteorclient.glrender.*;
import meteordevelopment.meteorclient.glrender.math.Point;
...
public abstract class ViewRoot implements ViewParent, AttachInfo.Callbacks {
    ...
    protected ViewRoot() {
        ...
        try {
            Class.forName("meteordevelopment.meteorclient.glrender.text.BoringLayout");
            Class.forName("meteordevelopment.meteorclient.glrender.font.CharArrayIterator");
            Class.forName("meteordevelopment.meteorclient.glrender.text.CharSequenceIterator");
            Class.forName("meteordevelopment.meteorclient.glrender.text.Directions");
            Class.forName("meteordevelopment.meteorclient.glrender.text.DynamicLayout");
            Class.forName("meteordevelopment.meteorclient.glrender.font.GlyphManager");
            Class.forName("meteordevelopment.meteorclient.glrender.font.GraphemeBreak");
            Class.forName("meteordevelopment.meteorclient.glrender.text.Layout");
            Class.forName("meteordevelopment.meteorclient.glrender.font.LayoutCache");
            Class.forName("meteordevelopment.meteorclient.glrender.font.LayoutPiece");
            Class.forName("meteordevelopment.meteorclient.glrender.font.LineBreaker");
            Class.forName("meteordevelopment.meteorclient.glrender.text.MeasuredParagraph");
            Class.forName("meteordevelopment.meteorclient.glrender.font.MeasuredText");
            Class.forName("meteordevelopment.meteorclient.glrender.text.PrecomputedText");
            Class.forName("meteordevelopment.meteorclient.glrender.text.Selection");
            Class.forName("meteordevelopment.meteorclient.glrender.text.SpannableString");
            Class.forName("meteordevelopment.meteorclient.glrender.text.SpannableStringBuilder");
            Class.forName("meteordevelopment.meteorclient.glrender.text.SpannableStringInternal");
            Class.forName("meteordevelopment.meteorclient.glrender.text.StaticLayout");
            Class.forName("meteordevelopment.meteorclient.glrender.text.TabStops");
            Class.forName("meteordevelopment.meteorclient.glrender.text.TextDirectionHeuristics");
            Class.forName("meteordevelopment.meteorclient.glrender.text.TextLine");
            Class.forName("meteordevelopment.meteorclient.glrender.text.TextPaint");
            Class.forName("meteordevelopment.meteorclient.glrender.text.TextUtils");
            Class.forName("meteordevelopment.meteorclient.glrender.text.Typeface");

            Class.forName("meteordevelopment.meteorclient.glrender.widget.Editor");
            Class.forName("meteordevelopment.meteorclient.glrender.widget.LinearLayout");
            Class.forName("meteordevelopment.meteorclient.glrender.widget.ScrollView");
            Class.forName("meteordevelopment.meteorclient.glrender.widget.TextView");
    ...
    boolean startDragAndDrop(@Nonnull View view, @Nullable Object data, @Nullable View.DragShadow shadow, int flags) {
        /*if (master.dragEvent != null) {
            MeteorClient.LOGGER.error(View.MARKER, "startDragAndDrop failed by another ongoing operation");
            return false;
        }*/
    ...
    private void performTraversal() {
        ...
        if (mLayoutRequested || width != host.getMeasuredWidth() || height != host.getMeasuredHeight()) {
            ...
            /*MeteorClient.LOGGER.info(MARKER, "Layout done in {} ms, window size: {}x{}",
