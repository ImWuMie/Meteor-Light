...
package meteordevelopment.meteorclient.glrender.util;
...
public class DataSet {
    ...
    static void typeWarning(int key, Object value, String className,
        ...
        MeteorClient.LOGGER.warn(MARKER, "Key {} expected {} but value was a {}. The default value {} was returned.",
                key, className, value.getClass().getName(), defaultValue);
        MeteorClient.LOGGER.warn(MARKER, "Attempt to cast generated internal exception", e);
    }
