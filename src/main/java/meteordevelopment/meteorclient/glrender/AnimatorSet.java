...
public final class AnimatorSet extends Animator implements AnimationHandler.FrameCallback {
    ...
    public void setStartDelay(long startDelay) {
        ...
        if (startDelay < 0) {
            MeteorGL.LOGGER.warn(MARKER, "Start delay should always be non-negative");
            startDelay = 0;
        }
    ...
    private void printChildCount() {
        ...
        list.add(mRootNode);
        MeteorGL.LOGGER.debug(MARKER, "Current tree: ");
        int index = 0;
        while (index < list.size()) {
            ...
            MeteorGL.LOGGER.debug(MARKER, builder.toString());
        }
    }
    ...
    private void updatePlayTime(@Nonnull Node parent, @Nonnull ArrayList<Node> visited) {
        ...
        for (int i = 0; i < childrenSize; i++) {
            ...
            if (index >= 0) {
                ...
                MeteorGL.LOGGER.warn(MARKER, "Cycle found in AnimatorSet: " + this);
                continue;
            }
