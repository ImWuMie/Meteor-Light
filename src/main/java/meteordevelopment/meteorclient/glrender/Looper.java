...
public final class Looper {
    ...
    public static Looper prepare() {
        ...
        final Looper looper = new Looper((MainWindow) null);
        ...
        if (logSlowDelivery) {
            if (me.mSlowDeliveryDetected) {
                if (dispatchStart - msg.when <= 10) {
                    MeteorClient.LOGGER.warn(MARKER, "Drained");
    ...
    public static void loop() {
        ...
        if (me.mInLoop) {
            MeteorClient.LOGGER.warn(MARKER, "Loop again would have the queued messages be executed"
    ...
    public static void prepare(@Nonnull Window w) {
        Core.checkMainThread();
        if (sMainLooper != null) {
            throw new IllegalStateException();
        }
    ...
    private static boolean showSlowLog(long threshold, long measureStart, long measureEnd,
        ...
        MeteorClient.LOGGER.warn(MARKER, "Slow {} took {}ms {} h={} c={} m={}",
