...
public class CustomPathFinder {
    ...
    private static boolean isBlockSolid(BlockPos block) {
        BlockState blockState = PathFinder.getBlockState(block);
        Block b = PathFinder.getBlock(block);

        return (
                ((blockState.isSolidBlock(mc.world, block) && blockState.isFullCube(mc.world,block))) || blockState.getMaterial().isSolid() || b instanceof SlabBlock || b instanceof StairsBlock || b instanceof CactusBlock || b instanceof ChestBlock || b instanceof EnderChestBlock || b instanceof SkullBlock || b instanceof PaneBlock ||
