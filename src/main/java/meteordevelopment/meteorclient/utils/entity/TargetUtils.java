...
import meteordevelopment.meteorclient.systems.modules.combat.MeteorAntiBot;
...
public class TargetUtils {
    ...
    public static PlayerEntity getPlayerTarget(double range, SortPriority priority) {
        ...
        return (PlayerEntity) get(entity -> {
            ...
            if (Modules.get().get(MeteorAntiBot.class).isBot((PlayerEntity) entity)) return false;
