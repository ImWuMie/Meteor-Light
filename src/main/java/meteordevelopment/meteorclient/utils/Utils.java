...
import meteordevelopment.meteorclient.utils.pathfinding.FlyingNodeProcessor;
import meteordevelopment.meteorclient.utils.pathfinding.Node;
import meteordevelopment.meteorclient.utils.pathfinding.NodeProcessor;
...
public class Utils {
    ...
    public static BlockState getBlockState(BlockPos pos) {
        return PathFinder.getBlockState(pos);
    }
    ...
    public static TeleportResult pathFinderTeleportTo(Vec3d from, Vec3d to) {
        ...
        if(!processor.isPassable(Utils.getBlockState(targetBlockPos),targetBlockPos)) {
            finalBlockPos = targetBlockPos.up();
            boolean lastIsPassable;
            if(!(lastIsPassable = processor.isPassable(Utils.getBlockState(targetBlockPos.up()),targetBlockPos.up()))) {
        ...
        processor.getPath(new BlockPos(from.x, from.y, from.z), finalBlockPos, 2460);
