...
public abstract class ImageWidget extends DrawableHelper implements Drawable, Element, Selectable {
    ...
    public ImageWidget(int x, int y, int imageWidth, int imageHeight, MeteorIdentifier image,boolean blur) {
        this.x = x / 2;
        this.y = y / 2;
